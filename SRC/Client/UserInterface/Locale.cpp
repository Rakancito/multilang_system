...
int MULTI_LOCALE_LANG = 0;

void LocaleService_LoadMyLangConfig(const char* fileName)
{
...
#ifdef ENABLE_MULTILANGUAGE
int LocaleService_GetMyLang()
{
	return MULTI_LOCALE_LANG;
}

void LocaleService_SetMyLang(BYTE blang)
{
	MULTI_LOCALE_LANG = blang;
}
#endif
