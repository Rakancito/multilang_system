...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	m_dwRealWeapon = src.m_dwRealWeapon;
#endif
...
#ifdef ENABLE_MULTILANGUAGE
	kCreateData.m_bCountry=rkNetActorData.m_bCountry;
#endif
...
#endif
#ifdef ENABLE_TRANSMUTATION
	kCreateData.m_dwRealWeapon=rkNetActorData.m_dwRealWeapon;
#endif
...
#ifdef ENABLE_MULTILANGUAGE
		pkInstFind->ChangeCountry(c_rkNetUpdateActorData.m_bCountry);
#endif
...
#ifdef ENABLE_MULTILANGUAGE
	rkNetActorData.m_bCountry = c_rkNetUpdateActorData.m_bCountry;
#endif
#ifdef NEW_PET_SYSTEM
...
#endif
#ifdef ENABLE_TRANSMUTATION
	rkNetActorData.m_dwRealWeapon=c_rkNetUpdateActorData.m_dwRealWeapon;
#endif
