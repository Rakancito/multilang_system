...
bool CPythonNetworkStream::RecvCharacterAppendPacket()
{
	...
	kNetActorData.m_dwRealWeapon=0;
#endif
...
bool CPythonNetworkStream::RecvCharacterAdditionalInfo()
{
	...
	if(kNetActorData.m_dwVID == chrInfoPacket.dwVID)
	{
...
#endif
#ifdef ENABLE_TRANSMUTATION
		kNetActorData.m_dwRealWeapon = chrInfoPacket.dwRealWeapon;
#endif
		...
		kNetActorData.m_bCountry=chrInfoPacket.bCountry;
#endif
		__RecvCharacterAppendPacket(&kNetActorData);
	}
	else
...
#ifdef ENABLE_AURA_COSTUME_SYSTEM
	kNetActorData.m_dwAura = chrAddPacket.awPart[CHR_EQUIPPART_AURA];
#endif
	kNetActorData.m_dwStateFlags=chrAddPacket.bStateFlag;
	kNetActorData.m_dwVID=chrAddPacket.dwVID;
...
#endif
#ifdef ENABLE_TRANSMUTATION
	kNetActorData.m_dwRealWeapon = chrAddPacket.dwRealWeapon;
#endif
...
#endif
#ifdef ENABLE_TRANSMUTATION
	kNetUpdateActorData.m_dwRealWeapon = chrUpdatePacket.dwRealWeapon;
#endif
...
#endif
#ifdef ENABLE_MULTILANGUAGE
	kNetUpdateActorData.m_bCountry=chrUpdatePacket.bCountry;
#endif
...
#ifdef ENABLE_TRANSMUTATION
		__SetWeaponPower(rkPlayer, pkNetActorData->m_dwRealWeapon);
#else
...
#ifdef ENABLE_TRANSMUTATION
		__SetWeaponPower(rkPlayer, pkNetUpdateActorData->m_dwRealWeapon);
#else
