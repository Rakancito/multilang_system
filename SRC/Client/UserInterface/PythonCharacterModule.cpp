...
PyObject * chrCreateInstance(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (PyTuple_Size(poArgs)==2)
	{
		...
		kCreateData.m_sPrestige=0;
#endif
#ifdef ENABLE_TRANSMUTATION
		kCreateData.m_dwRealWeapon=0;
#endif
...
PyObject * chrSetAura(PyObject* poSelf, PyObject* poArgs)
{
	...
	pkInst->SetAura(iRace);
	return Py_BuildNone();
}

PyObject * chrChangeAura(PyObject* poSelf, PyObject* poArgs)
{
	int iAura;
...
void initchr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{"ChangeAura",					chrChangeAura,						METH_VARARGS},
#endif
	...
	PyObject * poModule = Py_InitModule("chr", s_methods); //chr
/*
#ifdef PYTHON_MODULE_ANTIHACK
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_COMBAT_ZONE_POTION",		585);
#endif
