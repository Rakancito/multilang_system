...
PyObject* appGetMyLang(PyObject* poSelf, PyObject* poArgs)
{
	...
	switch (LocaleService_GetMyLang())
	{
		...
		case 5:
			...
			break;
		default:
			cCountry = DEFAULT_LANGUAGE;
			break;
	}
	return Py_BuildValue("s", cCountry);
}

PyObject* appSetMyLang(PyObject* poSelf, PyObject* poArgs)
{
	int szLang;
	if (!PyTuple_GetInteger(poArgs, 0, &szLang))
		return Py_BuildException();

	LocaleService_SetMyLang(szLang);
	return Py_BuildNone();
}
#endif
...
#ifdef ENABLE_MULTILANGUAGE
		{ "GetMyLang",					appGetMyLang,					METH_VARARGS },
		{ "SetMyLang",					appSetMyLang,					METH_VARARGS },
#endif
...
/*
	...
	PyModule_AddIntConstant(poModule, "LG_KILL_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "LG_KILL_EFFECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SEALBIND_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SEALBIND_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TRANSMUTATION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TRANSMUTATION", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_INVENTORY_SORT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_INVENTORY_SORT", 0);
#endif
#ifdef ENABLE_PINGTIME
...
#endif
#ifdef KYGN_AURA
	PyModule_AddIntConstant(poModule, "KYGN_AURA", 1);
#else
	PyModule_AddIntConstant(poModule, "KYGN_AURA", 0);
#endif
...
#endif
#ifdef ENABLE_NEW_SYSTEM_BLEND
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_SYSTEM_BLEND", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_SYSTEM_BLEND", 0);
#endif
