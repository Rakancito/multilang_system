...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_ITEM_DESTROY, sizeof(TPacketCGItemDestroy), "ItemDestroy", true); //Destruis item
	...
	Set(HEADER_CG_SHOP2, sizeof(TPacketCGShop2), "Shop2", true);
	...
	Set(HEADER_CG_CHANGE_LANG, sizeof(TPacketCGChangeLang), "ChangeLang");
#endif
	...
	Set(HEADER_CG_TRANSMUTATION_ADD_SLOT, sizeof(TPacketCGTransmutationAddSlot), "TransmutationAddSlot", true);
	Set(HEADER_CG_TRANSMUTATION_DELETE_SLOT, sizeof(TPacketCGTransmutationDeleteSlot), "TransmutationDeleteSlot", true);
#endif
