...
class CClientManager : public CNetBase, public singleton<CClientManager>
{
	...
	void		QUERY_ACCOUNT_CHANGE_LANGUAGE(CPeer * peer, DWORD dwHandle, TPacketGDChangeLanguage * data);
#endif
	...
	void	GuildDungeonST(TPacketGDGuildDungeonST* sPacket); //Fix meley lair
#endif
