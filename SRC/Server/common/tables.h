...
enum
{
...
#endif
	#ifdef __DUNGEON_FOR_GUILD__
	HEADER_GD_GUILD_DUNGEON_ST = 146, //Fix meley lair
	#endif
	...
	HEADER_DG_GUILD_DUNGEON_ST = 184, //Fix meley lair
	#endif
...
#ifdef ENABLE_MULTILANGUAGE
typedef struct SPacketGDChangeLanguage
{
	DWORD dwAccountID;
	BYTE blang;
} TPacketGDChangeLanguage;
#endif
/**
